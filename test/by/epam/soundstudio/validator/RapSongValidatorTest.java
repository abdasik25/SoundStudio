...
public class RapSongValidatorTest {


    private boolean expected;
    private String actual;

    public RapSongValidatorTest(boolean expected, String actual) {
    ...
    public static Collection<Object[]> getParametrs() {
        return Arrays.asList(new Object[][]{
                {true, "name - surname, 2, 3, country, 4, beatmaker, samplesong"},
                {false, "name, 2, 3, country, 4, beatmaker, samplesong"},
        });
    }
    @Test
    public void rapSongValidatorTest(){
