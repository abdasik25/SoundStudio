...
public class DurationComparatorTest {
    ...
    public DurationComparatorTest(RockSong rockSongGreater, RockSong rockSongSmaller) {
    ...
    @Test
    public void durationComparatorTest(){
        DurationComparator durationComparator = new DurationComparator();
        int result = 1;
        assertEquals(result, durationComparator.compare(rockSongGreater, rockSongSmaller));
    }
}