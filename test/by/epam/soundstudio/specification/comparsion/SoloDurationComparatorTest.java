...
public class SoloDurationComparatorTest {

    private RockSong rockSongGreater;
    private RockSong rockSongSmaller;

    public SoloDurationComparatorTest(RockSong rockSongGreater, RockSong rockSongSmaller) {
    ...
    @Test
    public void soloDurationComparatorTest(){
        SoloDurationComparator soloDurationComparator = new SoloDurationComparator();
        int result = 1;
        assertEquals(result, soloDurationComparator.compare(rockSongGreater, rockSongSmaller));
    }
}